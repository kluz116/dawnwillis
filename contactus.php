...
<!-- Mirrored from htmlcoder.me/preview/the_project/v.1.1/template/page-contact-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Jan 2016 13:49:16 GMT -->
<head>
		<meta charset="utf-8">
		<title>Contact us| Dawn Wills Ministries International</title>
							...
							<div class="col-md-3">
								...
								<div class="header-left clearfix">
									...
									<div id="logo" class="logo">
										<a href="index"><img id="logo_img" src="images/logo_gold.png" alt="The Project"></a>
									</div>
					...
					<div class="row">
						...
						<div class="main col-md-8">
							...
							<div class="contact-form">
									...
									<input type="submit" id="addContact" value="Submit" class="submit-button btn btn-default">
						...
						<aside class="col-md-4 col-lg-3 col-lg-offset-1">
							<div class="sidebar">
								<div class="block clearfix">
									...
									<div class="separator-2"></div>
									<ul class="list">
										<li><i class="fa fa-home pr-10"></i>Kiira Road Kamwokya Opp Mahidira</li>
										<li><i class="fa fa-phone pr-10"></i><abbr title="Phone">P:</abbr> +256 781 893 085</li>
										<li><i class="fa fa-envelope pr-10"></i><a href="mailto:info@dawnwillisministriesinternational.org">info@dawnwillisministries.org</a></li>
									</ul>
							...
							<div class="row">
								<div class="col-md-8">
									<div class="footer-content">
										...
										<div class="row">
											<div class="col-md-6">
												<p>Bishop Dr. Dawn Willis is an internationally acclaimed motivation spearker,author,mentor and mother.Indeed she is a lady with many hats, humble and very resilent in her service for the Lord Jesus Christ. She is the founder and mother of Dawn Willis Ministries International and prevailing Truth World Outreach ministries international.</p>
